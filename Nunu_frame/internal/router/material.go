...
func InitMaterialRouter(
	...
	{
		noAuthRouter.PUT("/UpdateAuditingMaterialList", deps.MaterialRouter.UpdateAuditingMaterialList)
		...
		noAuthRouter.POST("/UpAuditMaterial", deps.MaterialRouter.UpAuditMaterial)
